...
public class WithOUTUtilityclass extends BaseClass{
//	@Test
...
//		test.log(Status.INFO, "navigate to org");
//		HomePage h=new HomePage(driver);
//		h.getOrgLink().click();
//		test.log(Status.INFO, "navigate to createorg");
...
//		c.createOrg(orgName);
//		test.log(Status.INFO ,  orgName + "create a new org");
